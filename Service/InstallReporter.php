<?php
/**
 * Standalone install + heartbeat reporter for Panth_SmartBadge.
 *
...
namespace Panth\SmartBadge\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_SmartBadge';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-smart-badge';
